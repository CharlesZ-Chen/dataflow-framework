...
//    protected final Types types;
    ...
    public void performAnalysis(ControlFlowGraph cfg) {
        ...
        while (!worklist.isEmpty()) {
            ...
            case EXCEPTION_BLOCK: {
                ...
                TransferResult<V, S> transferResult = callTransferFunction(
                        node, currentInput);
     ...
     * flowRule.
     */
    protected void propagateStoresTo(Block succ, Node node, TransferInput<V, S> currentInput,
   ...
   @Override
    ...
    public List<Pair<ReturnNode, TransferResult<V, S>>> getReturnStatementStores() {
        ...
        for (ReturnNode returnNode : cfg.getReturnNodes()) {
            TransferResult<V, S> store = storesAtReturnStatements
                    .get(returnNode);
